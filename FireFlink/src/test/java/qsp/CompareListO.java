...
public class CompareListO {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// int y =
		// driver.findElement(By.xpath("((//a[@href='/build-your-own-computer'])[2]")).getLocation().getY();
		...
		System.out.println("Both product added to compare List");
